...
The typical approach to the study of GWs is to derive them as small perturbations of the background from the Einstein's equations: 
\begin{equation}
    G_{\mu\nu} = R_{\mu\nu} - \frac{1}{2}g_{\mu\nu}R,
\end{equation}
...
The purpose of this work, however, is to discover if the \textit{extra-galactic} binaries, despite their much grater distance, are sufficiently numerous to generate an overall detectable stochastic GW background in the LISA band.
