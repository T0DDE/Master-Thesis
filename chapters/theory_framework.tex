...
\subsection{\correzione{The} Laser Interferometer Space Antenna (LISA)}
Currently operating detectors such as LIGO and Virgo (\correzione{\cite{PhysRevLett.116.061102},~\cite{Abbott_2019}}) have pioneered the technique we have just shown in the high-frequency band (\correzione{\cite{LISA_ref},~\cite{Virgo_cit}}).
