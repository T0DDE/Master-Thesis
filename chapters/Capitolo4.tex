...
\begin{itemize}
    \item population's parameters (the ones COSMIC gives to user)
        \begin{itemize}
            \item parameter distribution graphs
        \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item Scaling to astrophysical population, what is needed (refer to next chapter)
\end{itemize}
