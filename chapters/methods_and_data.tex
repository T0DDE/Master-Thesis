...
Fortunately, a direct correspondence exists between T-type values and Hubble types, presented in~\cite{De_Vaucouleurs_1974}, and thanks to the results in~\cite{Faber&Gallagher} we find the following correspondences:
\begin{table}[h!]
    \centering
    \begin{tabular}{ccc}
